...
- 이론명, 저자명, 출판연도, 논문명은 서사에 직접 인용하지 마라. 근거는 자연스러운 설명으로만 반영하라.
- a와 b는 각각 title, summary, detail, gain, cost를 포함한다.
- title은 20자 이내, summary는 핵심 trade-off 한 문장(90자 이내)으로 압축한다.
- detail은 present, transition, future로 구성하며 각각 한 문장(70자 이내)이고 summary를 반복하지 않는다.
- gain과 cost는 각각 35자 이내로 작성한다.
...
IMAGE SCENE DIRECTIONS (required, very concise):
...
- Each visual object must contain only one field named scene.
- scene is one vivid sentence of at most 35 English words covering setting, action,
  emotion, key objects, and camera angle.
...
- Final output must be one JSON object with this shape:
  {"a":{"title":"...","summary":"...","detail":{"present":"...","transition":"...","future":"..."},"gain":"...","cost":"..."},"b":{"title":"...","summary":"...","detail":{"present":"...","transition":"...","future":"..."},"gain":"...","cost":"..."},"comparison":{"summary":"...","question":"..."},"visual_a":{"scene":"..."},"visual_b":{"scene":"..."}}
"""
