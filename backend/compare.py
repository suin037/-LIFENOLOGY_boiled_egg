...
from core import run_prediction, new_profile_cache, KIND_TREATMENT
...
def build_comparison(req: CompareRequest) -> CompareResponse:
    ...
    a = _scenario_view(profile_dict, req.choice_a, shared)
    b = _scenario_view(profile_dict, req.choice_b, shared)
